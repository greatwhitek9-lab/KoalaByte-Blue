...
SUBMENU_ITEMS: Dict[str, List[dict[str, object]]] = {
    ...
    "bluetooth": [
        ...
        {"group": "Bluetooth Tools", "label": "Didgeridoo Meshtastic", "command": "didgeridoo", "description": "Run safe Meshtastic status, node table, and GNSS/status bundle"},
        {"group": "Bluetooth Tools", "label": "Greatwhite Reef Patrol", "command": "greatwhite_status", "description": "Check jungle-lab tshark/Wireshark readiness and local capture tooling"},
        {"group": "Bluetooth Tools", "label": "Greatwhite Interface Lagoon", "command": "greatwhite_interfaces", "description": "List owned lab packet-review interfaces before any bounded capture"},
        {"group": "Bluetooth Tools", "label": "nRF Sniffer Nest Check", "command": "nrf_sniffer_check", "description": "Check host-side Nordic nRF Sniffer extcap status without redistributing Nordic files"},
    ...
    "system": [
        {"group": "System / Companion", "label": "Koala Mode Switcher", "command": "koala_mode_switcher", "description": "Choose the active Heltec T114 profile: Lab/mouth/BLE/GNSS or Koala Konnect T114"},
