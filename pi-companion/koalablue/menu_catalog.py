...
SUBMENU_ITEMS: Dict[str, List[dict[str, object]]] = {
    "eucalyptus": [
        ...
        _item("Bluetooth Tools", "Eucalyptus WiGLE Upload", "eucalyptus wigle-upload", "Upload explicitly armed GPS-tagged observations"),
    ...
    "kruisin": [
        ...
        _item("Reports & Reviews", "Kruisin’ WiGLE Upload", "kruisin wigle-upload", "Upload survey data when explicitly armed"),
        _item("System / Companion", "Back to Main Canopy", "submenu:main", "Return to the main menu"),
    ],
    "bluetooth": [
