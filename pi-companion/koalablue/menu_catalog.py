...
FUNCTION_MENU_ITEMS: List[dict[str, object]] = [
    ...
    {"group": "Bluetooth Tools", "label": "Eucalyptus Mode", "command": "eucalyptus_mode", "description": "Koalagotchi always-on Bluetooth scanner and logger screen; KillerKoala eats passive eucalyptus data and stays open until quit"},
    ...
    {"group": "Reports & Reviews", "label": "Boomerang", "command": "boomerang", "description": "Camera-awareness Koalagotchi-style logbook settings; records public/visible camera details, awards XP, and stays open until quit"},
