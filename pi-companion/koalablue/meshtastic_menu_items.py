...
def make_didgeridoo_items(menu_item_cls: Type[T]) -> List[T]:
    rows = [
        ...
        ("Create Location Password", _KB_LOCAL_LOCK_SET, "Open protected pop-up keyboard to create or update the local password", "Didgeridoo"),
        ("Unlock Current Process", _KB_LOCAL_LOCK_OPEN, "Open protected pop-up keyboard to unlock this running process", "Didgeridoo"),
