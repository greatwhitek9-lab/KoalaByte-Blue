...
DEFAULT_BUTTONS: Dict[str, Dict[str, object]] = {
    ...
    "button_7": {"number": 7, "module_key": "K7", "label": "PWR", "pin": 20, "physical_pin": 38, "press_command": "shutdown"},
    "button_8": {"number": 8, "module_key": "K8", "label": "Reset", "pin": 16, "physical_pin": 36, "press_command": "main_menu", "alias_command": "reset"},
}
