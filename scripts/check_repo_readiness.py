...
NEEDED = [
    ...
    "pi-companion/koalablue/local_actions.py",
...
REQUIRED_TEXT = {
    ...
    "pi-companion/koalablue/menu_catalog.py": [
        "SUBMENU_ITEMS", "leaf_menu_entries", "Greatwhite Reef Patrol", "AntEater", "Didgeridoo Meshtastic",
        "koala_kapture", "urban_poaching", "settings", "buttons",
    ],
    "pi-companion/koalablue/menu_theme.py": ["JungleMenuTheme", "GREATWHITE REEF", "SNIFFER NEST"],
    "pi-companion/koalablue/menu_action_dispatcher.py": [
        "SAFE_COMMANDS", "_local_action_map", "koala_kapture", "urban_poaching", "settings", "buttons",
        "didgeridoo", "run_didgeridoo.py", "run_anteater.py", "run_koala_kry.py", "run_koala_kan_kommander.py",
    ],
    ...
    "pi-companion/koalablue/local_actions.py": ["koala_kapture", "urban_poaching", "settings", "buttons", "LocalActionResult"],
