...
NEEDED = [
    ...
    "docs/ZEPHYR_DEPENDENCIES_FLASH_ALL.md",
    "docs/T114_EXTERNAL_2G4_ANTENNA.md",
...
TEXT = {
    ...
    "docs/MESHTASTIC_APP_T114.md": ["run_meshtastic_app.py", "run_location_password_gate.py", "--confirm-send", "protected-actions password"],
    "docs/ZEPHYR_DEPENDENCIES_FLASH_ALL.md": ["BUILD_KOALA_KONNECT", "nRF Connect SDK", "build_koala_konnect_t114.sh", "flash_koala_konnect_t114.sh"],
    "docs/T114_EXTERNAL_2G4_ANTENNA.md": ["T114_2G4_ANTENNA", "Do not guess an RF-switch GPIO", "2.4 GHz antenna connector", "LoRa antenna connector"],
    "docs/GREATWHITE_WIRESHARK_TSHARK.md": ["Greatwhite", "run_gw.py", "--confirm-owned-lab", "setup_nrf_sniffer_ble.sh"],
    ...
    "scripts/build_koala_konnect_t114.sh": ["KOALA_KONNECT_MODE_NAME", "build_nrf52840_t114_hci_usb.sh"],
    "scripts/flash_koala_konnect_t114.sh": ["KOALA_KONNECT_MODE_NAME", "flash_nrf52840_t114_hci_usb.sh"],
}
