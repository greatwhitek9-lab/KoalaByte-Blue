...
REQUIRED_FILES = [
    ...
    "docs/OPTIONAL_T114_FIRMWARE_ARTIFACTS.md",
    ...
    "scripts/write_optional_t114_firmware_artifacts.py",
...
REQUIRED_TEXT = {
    ...
    "docs/MINED_HELTEC_V2_FEATURES.md": [
        ...
        "write_optional_t114_firmware_artifacts.py",
        "--confirm-send",
    ],
    "docs/OPTIONAL_T114_FIRMWARE_ARTIFACTS.md": [
        ...
        "gnss_nmea",
        "ble_adv_seen",
        "Do not add optional T114 HCI USB or Heltec color-mouth firmware",
    ],
    "docs/ESP32_TOUCH_MENU_CALIBRATION.md": [
        "ESP32-S3 DualEye Touch Menu Calibration",
        "menu_touch JSON",
        "run_esp32_touch_menu_bridge.py",
    ...
    "pi-companion/koalablue/killerkoala_voice_face_control.py": [
        "killerkoala spoken-command module executor",
        "show_wake_face",
        "show_speaking_face",
        "execute_module",
        "parse_voice_command",
    ...
    "scripts/write_optional_t114_firmware_artifacts.py": [
        "OPTIONAL_T114_FIRMWARE_ARTIFACTS_RECORDED",
        "t114_hci_usb_mode.json",
        "t114_active_ble_mode.json",
        "killerkoala_face",
        "gnss_nmea",
        "ble_adv_seen",
    ],
    ...
    "scripts/check_esp32_touch_menu.py": ["Esp32TouchMenuBridge", "touch_menu_bridge", "menu_touch"],
    "scripts/run_esp32_touch_menu_bridge.py": ["Esp32TouchMenuBridge", "--calibrate", "KOALABYTE_ESP32_FACE_PORT"],
    "scripts/run_killerkoala_face_demo.py": ["killerkoala_face_bridge", "--sequence", "killerkoala online"],
    "scripts/run_menu_screen.py": [
        "run_anteater_action",
