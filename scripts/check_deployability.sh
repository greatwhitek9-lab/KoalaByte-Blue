...
run_step "Final one-shot check-only" bash one-shot-install.sh --check-only

write_status "DEPLOYABILITY_READY" "canonical Pi OS Lite one-shot, K1-K8, menu, voice, display sync, services, and no-flash policies passed"
trap - ERR
