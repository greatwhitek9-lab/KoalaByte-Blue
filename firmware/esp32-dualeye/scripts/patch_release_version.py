...
new = '#define KOALABLUE_FW_VERSION "0.9.8-dualeye-static-grammar-40-response-bank"'
...
print(f"Stamped DualEye firmware version 0.9.8 static grammar 40-response bank: {path}")
