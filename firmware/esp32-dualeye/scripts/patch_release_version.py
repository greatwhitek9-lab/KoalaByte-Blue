...
new = '#define KOALABLUE_FW_VERSION "0.9.12-dualeye-fallback-entry-diagnostics"'
...
print(f"Stamped DualEye firmware version 0.9.12 fallback entry diagnostics: {path}")