...
# The wrapper supplies eight compact local-response phrases. Keep the complete
# MultiNet command set below the documented 200-command ceiling.
...
print(
    "Generated DualEye voice/menu catalog: "
